...
func searchEstateNazotte(c echo.Context) error {
	...
	query := `SELECT * FROM estate force index(idx_popularity_id) WHERE latitude <= ? AND latitude >= ? AND longitude <= ? AND longitude >= ? ORDER BY negative_popularity ASC, id ASC`
